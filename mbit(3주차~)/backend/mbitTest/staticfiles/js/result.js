...
Kakao.init('46a0b385b0bfdd2393e131141f912606');
// Kakao.isInitialized();
...
function sendLink() {
    ...
    Kakao.Link.sendDefault({
        ...
        content: {
            ...
            imageUrl: 'https://mbittest-ptrzw.run.goorm.io//static/img/mbit_thumbnail.png',
            link: {
                mobileWebUrl: 'https://mbittest-ptrzw.run.goorm.io/,
                webUrl: 'https://mbittest-ptrzw.run.goorm.io/,
            },
        },
        social: {
            likeCount: 286,
